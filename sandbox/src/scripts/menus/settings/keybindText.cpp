...
nlohmann::ordered_json KeybindText::getAsJSON()
{
...
#ifndef NG_DEPLOY
void KeybindText::displayImGui()
{
	NativeScript::displayImGui();

	ImGui::BeginGroup();
	if (ImGui::BeginCombo(std::string("config###playerConfig1").c_str(), toString(m_function).c_str(), ImGuiComboFlags_PopupAlignLeft))
	{
