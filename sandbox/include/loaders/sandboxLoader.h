...
*
*/
#ifndef SANDBOXLOADER_H
#define SANDBOXLOADER_H
...
namespace OwlEngine
{
	...
	*/
	...
	public:
		static void setLoadcallback(); //!< Set the callback for the engine loader
		...
		static void loadEntities(Scene* scene, Entity* m_parent, const std::string& entityFilePath); //!< Load entities into the scene
	};
}
