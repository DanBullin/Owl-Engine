...
namespace OwlEngine
{
	...
	*/
	...
	//! setDecorated
	/*!
	\param decorated a bool - Set the glfw decorated flag
	*/
	void GLFWWindowImplementation::setDecorated(bool decorated)
	{
		if(decorated) glfwSetWindowAttrib(static_cast<GLFWwindow*>(m_native), GLFW_DECORATED, GLFW_TRUE);
		else glfwSetWindowAttrib(static_cast<GLFWwindow*>(m_native), GLFW_DECORATED, GLFW_FALSE);
	}
