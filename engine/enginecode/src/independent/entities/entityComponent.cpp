...
namespace OwlEngine
{
	...
	*/
	...
	//! setChanged()
	/*!
	\param change a const bool - Has this component been changed
	*/
	void EntityComponent::setChanged(const bool change)
	{
		m_changed = change;
	}
	...
	//! getChanged()
	/*!
	\return a const bool - Has this component been changed
	*/
	const bool EntityComponent::getChanged()
	{
		return m_changed;
	}
}