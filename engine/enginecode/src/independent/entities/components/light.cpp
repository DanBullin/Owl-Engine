...
#pragma region "Direction"
	...
	*/
	nlohmann::ordered_json DirectionalLight::getAsJSON()
	{
		nlohmann::ordered_json data;

		data["name"] = m_name;
		data["type"] = Components::toString(m_componentType);
		data["direction"] = { m_direction.x, m_direction.y, m_direction.z };
		data["ambient"] = { m_ambient.x, m_ambient.y, m_ambient.z };
	...
	void DirectionalLight::displayImGui()
	{
		...
		ImGui::DragFloat3(std::string("world position###" + m_name).c_str(), &worldPos.x, 0.1f, 0.f, 0.f, "%.2f");
		ImGui::DragFloat3(std::string("direction###" + m_name).c_str(), &m_direction.x, 0.1f, 0.f, 0.f, "%.2f");
		ImGui::DragFloat3("###ambient1", &m_ambient.x, 0.005f, 0.f, 999.f);
		ImGui::SameLine();
		ImGui::ColorButton("##ambient2", ImVec4(m_ambient.x, m_ambient.y, m_ambient.z, 1.f), ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(20, 20));
		ImGui::SameLine();
		ImGui::Text("ambient");
		ImGui::DragFloat3("###diffuset1", &m_diffuse.x, 0.005f, 0.f, 999.f);
		ImGui::SameLine();
		ImGui::ColorButton("###diffuse2", ImVec4(m_diffuse.x, m_diffuse.y, m_diffuse.z, 1.f), ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(20, 20));
		ImGui::SameLine();
		ImGui::Text("diffuse");
		ImGui::DragFloat3("###specular1", &m_specular.x, 0.005f, 0.f, 999.f);
		ImGui::SameLine();
		ImGui::ColorButton("###specular2", ImVec4(m_specular.x, m_specular.y, m_specular.z, 1.f), ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(20, 20));
		ImGui::SameLine();
		ImGui::Text("specular");
	}
#endif // NG_DEPLOY
...
#pragma region "Point"
	...
	*/
	...
	\return a nlohmann::ordered_json - The component's data in JSON format
	*/
	nlohmann::ordered_json PointLight::getAsJSON()
	{
		nlohmann::ordered_json data;
	...
	{
		glm::vec3 worldPos = getWorldPosition();
		ImGui::DragFloat3(std::string("world position###ori3" + m_name).c_str(), &worldPos.x, 0.1f, 0.f, 0.f, "%.2f");
		ImGui::DragFloat3("###ambient1", &m_ambient.x, 0.005f, 0.f, 999.f);
		ImGui::SameLine();
		ImGui::ColorButton("##ambient2", ImVec4(m_ambient.x, m_ambient.y, m_ambient.z, 1.f), ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(20, 20));
		ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::Text("specular");
		ImGui::DragFloat("constant", &m_constant, 0.001f, 0.f, 0.f);
		ImGui::DragFloat("linear", &m_linear, 0.001f, 0.f, 1.f);
		ImGui::DragFloat("quadratic", &m_quadratic, 0.001f, 0.f, 1.f);
	}
#endif // NG_DEPLOY
...
#pragma region "Spot"
	...
	*/
	...
	\return a nlohmann::ordered_json - The component's data in JSON format
	*/
	nlohmann::ordered_json SpotLight::getAsJSON()
	{
		nlohmann::ordered_json data;
	...
	{
		glm::vec3 worldPos = getWorldPosition();
		ImGui::DragFloat3(std::string("world position###wor3" + m_name).c_str(), &worldPos.x, 0.1f, 0.f, 0.f, "%.2f");
		ImGui::DragFloat3(std::string("direction###dir3" + m_name).c_str(), &m_direction.x, 0.1f, 0.f, 0.f, "%.2f");
		ImGui::DragFloat3("###ambient1", &m_ambient.x, 0.005f, 0.f, 999.f);
		ImGui::SameLine();
		ImGui::ColorButton("##ambient2", ImVec4(m_ambient.x, m_ambient.y, m_ambient.z, 1.f), ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(20, 20));
		ImGui::SameLine();
		ImGui::Text("ambient");
		ImGui::DragFloat3("###diffuse1", &m_diffuse.x, 0.005f, 0.f, 999.f);
		ImGui::SameLine();
		ImGui::ColorButton("###diffuse2", ImVec4(m_diffuse.x, m_diffuse.y, m_diffuse.z, 1.f), ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(20, 20));
		ImGui::SameLine();
		ImGui::Text("diffuse");
		...
		ImGui::SameLine();
		ImGui::Text("specular");
		ImGui::DragFloat("constant", &m_constant, 0.01f, 0.f, 0.f);
		ImGui::DragFloat("linear", &m_linear, 0.01f, 0.f, 0.f);
		ImGui::DragFloat("quadratic", &m_quadratic, 0.01f, 0.f, 0.f);
		ImGui::DragFloat("cut off", &m_cutOff, 0.05f, 0.f, 360.f);
		ImGui::DragFloat("outer cut off", &m_outerCutOff, 0.05f, 0.f, 360.f);
	}
#endif // NG_DEPLOY
