...
namespace OwlEngine
{
	...
	*/
	void RenderSystem::onRender(Scene* scene)
	{
		...
		// Now we have all the render passes for this scene and a list of all the entities in the scene
		// Go through each render pass in the order in which they were added and render (if they're enabled)
