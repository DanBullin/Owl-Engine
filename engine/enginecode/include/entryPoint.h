...
extern OwlEngine::Application* OwlEngine::startApplication(); //!< Global variable available everywhere with external linkage
...
int main(int argc, char** argv)
{
	...
	auto application = OwlEngine::startApplication();
	application->run();
