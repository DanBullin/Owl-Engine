...
namespace OwlEngine
{
	...
	*/
	...
	public:
		...
		static glm::mat4 getModelMatrix(const glm::vec3& pos, const glm::vec3& rotation, const glm::vec3& scale); //!< Get a model matrix using position and scale and rotation
	};
}
#endif