...
namespace OwlEngine
{
	...
	*/
	...
	public:
		...
		virtual void setDecorated(bool decorated) = 0; //!< Sets whether the window has a title bar etc
			/*!< \param decorated a bool - True means there is a title bar, false means none */
