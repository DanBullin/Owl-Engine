...
namespace OwlEngine
{
	...
	*/
	...
	protected:
		...
		std::string m_name; //!< The name of the pass
	...
	public:
		...
		void setName(const std::string& value); //!< Set the name of this render pass
		std::string getName() const; //!< Get the name of this render pass
