...
namespace OwlEngine
{
	...
	*/
	...
	private:
		...
		uint32_t m_uniqueID; //!< A unique value for the entity
		...
		bool m_selected; //!< Is this entity selected
		bool m_save; //!< Save this entity
	public:
		Entity(); //!< Constructor
		...
		void setUniqueID(const uint32_t ID); //!< Set the unique ID of this entity
		uint32_t getUniqueID(); //!< Get the unique ID value of this entity
		...
		void setSelected(const bool select); //!< Set whether the entity is selected
		const bool getSelected() const; //!< Get whether the entity is selected

		void setSaved(const bool save); //!< Set whether the entity should be save when the scene is saved
		const bool getSaved() const; //!< Get whether the entity is saved
		...
		void printEntityDetails(); //!< Print entity details
		nlohmann::ordered_json getAsJson(); //!< Get the entities data in JSON format
	};
