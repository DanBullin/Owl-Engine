...
namespace OwlEngine
{
	...
	*/
	...
	public:
		...
		glm::vec3 getFrontWorldPosition(const float frontMultiplied); //!< Get the world position along the camera's front vector
		...
		void updateProjection(glm::ivec2 size); //!< Update the projection
	};
}
#endif